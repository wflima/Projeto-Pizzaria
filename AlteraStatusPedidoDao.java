...
public class AlteraStatusPedidoDao {

	public void alterarPedido(Pedido pedido) throws ClassNotFoundException,
			SQLException {
	...
	public List<Pedido> litarTodosPedidos() throws ClassNotFoundException,
			SQLException {
		Conexao conexao = new Conexao();
		Connection con = conexao.conetarNoBancoDeDados();
		String sql = "SELECT *  FROM pedido  where status=0";
		PreparedStatement ps = con.prepareStatement(sql);
